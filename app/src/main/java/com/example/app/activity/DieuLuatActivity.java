...
import com.example.app.adapter.DanhSachDieu16Adapter;
import com.example.app.adapter.DanhSachLuatAdapter;
    ...
    private void loadMore() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                danhSachLuat16Adapter.notifyItemRemoved(listDieu16.size() - 1);
                page = page+1;
                getData(page);
